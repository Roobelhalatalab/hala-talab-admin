...
function renderDashboard(user) {
  ...
  wireDashboard(); wireAdminNotifications(); renderStageTwoDashboard();
}
...
const systemPageState = {
  tab: 'overview',
  categories: [], clientCategories: [], coupons: [], platformCoupons: [], couponSettlements: [], promotions: [], support: [], partnerSupport: [], pinResets: [], commissions: [], subscriptions: [], settings: [], audit: [], stores: [],
  ...
  offerFilter: 'all', offerSearch: '', editingPlatformCouponId:null, settlementFilter:'all', settlementSearch:'',
...
function renderSystemOffers() {
  ...
  const promoRows=filteredOfferRows(systemPageState.promotions,promoTitle);
  return `<div class="system-section-head offers-head"><div><h3>الكوبونات والعروض</h3><p>كوبونات هلا طلب المركزية + كوبونات وعروض المتاجر، مع حدود استخدام واضحة.</p></div><span class="tag">${fmtNumber(platformRows.length+couponRows.length+promoRows.length)} نتيجة</span></div>
